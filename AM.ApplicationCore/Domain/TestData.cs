...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        {
            Name = new FullName { FirstName = "captain", LastName = "captain" },
        ...
        {
            Name = new FullName { FirstName = "hostess1", LastName = "hostess1" },
        ...
        {
            Name = new FullName { FirstName = "hostess2", LastName = "hostess2" },
        ...
        {
            Name = new FullName { FirstName = "traveller1", LastName = "traveller1" },
        ...
        {
            Name = new FullName { FirstName = "traveller2", LastName = "traveller2" },
        ...
        {
            Name = new FullName { FirstName = "traveller3", LastName = "traveller3" },
        ...
        {
            Name = new FullName { FirstName = "traveller4", LastName = "traveller4" },
        ...
        {
            Name = new FullName { FirstName = "traveller5", LastName = "traveller5" },
